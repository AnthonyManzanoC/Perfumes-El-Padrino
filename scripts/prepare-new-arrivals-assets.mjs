...
// then use the requested product, detail, and packshot views.
...
console.log('Prepared the new-arrival galleries, including the four-view client-selected Invictus gallery.');
